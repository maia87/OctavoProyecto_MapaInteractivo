marcadorModulo = (function () {
  ...
  // Crea un marcador en la posición pasada por parámetro y lo muestra en el mapa
  function mostrarMiMarcador (ubicacion) {
    miMarcador = new google.maps.Marker({
      position: ubicacion, //objeto LatLng
      map: mapa, //le asigno el mapa en el cual debe ubicarse el marcador
      tittle: 'Aquí estoy',
      animation: google.maps.Animation.DROP, //aplico animacion del tipo DROP
